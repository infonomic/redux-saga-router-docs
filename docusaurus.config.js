...
const config = {
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/infonomic/redux-saga-router',
        },
        theme: {
  ...
  themeConfig:
    ...
    ({
      navbar: {
        title: 'Redux-Saga Router',
        logo: {
          alt: 'Infonomic Redux-Saga Router',
          src: 'img/logo.svg',
        },
        items: [
          {
      ...
      footer: {
        ...
        //   },
        // ],
        copyright: `Copyright © ${new Date().getFullYear()} <a href="https://infonomic.io">Infonomic Co., Ltd.</a> Built with Docusaurus.`,
      },
      prism: {
        theme: darkCodeTheme,
